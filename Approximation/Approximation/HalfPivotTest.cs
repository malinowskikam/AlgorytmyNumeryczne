...
namespace Approximation
{
    class HalfPivotTest
    {
        ...
        {
            Console.WriteLine("gaussian half-pivot");
            Console.WriteLine();
            ...
            for (int i = 0; i < agentCounts.Length; i++)
            {
                ...
                IMatrixEquasionEvaluator<double> mee = new GaussianHalfPivot();
            ...
            Console.WriteLine();
            CubicFunction c = new CubicFunction(equasionCount, executionTimes);
